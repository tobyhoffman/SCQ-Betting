...
class Algorithm:
    ...
    def run(self):
        ...
        for game in todays_games:
            ...
            if offensiveEfficiency(team1) > offensiveEfficiency(
                team2
            ) and defensiveEfficiency(team1) > defensiveEfficiency(team2):
                bets.append(Bet(team1, 2))  # bet a fixed wager of 2 units on team1

            elif offensiveEfficiency(team2) > offensiveEfficiency(
                team1
            ) and defensiveEfficiency(team2) > defensiveEfficiency(team1):
